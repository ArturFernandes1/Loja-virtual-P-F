        ...
        <div className="container2">
                <div className="text2">
                    ...
                    <div className="quad-1">
                        <p className="text-over-heading">
                        Fornecer móveis práticos que atendam às necessidades dos clientes, garantindo conforto e funcionalidade. </p>
                    </div>
                    <div className="quad-1">
                        <p className="text-over-heading">Inspiramos ambientes com soluções criativas e móveis únicos, criados com cuidado artesanal, elevando espaços com elegância.</p>
